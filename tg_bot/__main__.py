...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hello World Am 𝕮𝖍𝖎𝖙𝖙𝖎 Reloaded Version 2.0 🔥...🚴‍♂️Speed 1 THz..Memory 1 Zettabyte.🕺🏻")
...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="💠Add Me💠",url="http://t.me/zoldycktmbot?startgroup=true"),InlineKeyboardButton(text="♻️Owner",url="https://telegram.dog/Villain_Of_Telegram")]]
